...
export const initialMessages = [
  {
    role: 'assistant',
    content: 'Hi! I am your Competitive programming coach. Please send me a message to start our acquaintance!',
  },
];
    ...
    <div className="mx-auto flex-1 w-full md:mx-auto md:mb-[52px] lg:max-w-2xl xl:max-w-3xl">
      <div className="relative flex-1 flex-col rounded-md border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] sm:mr-auto">
        <input
          ...
          required
          className="m-0 w-full border-0 bg-transparent p-0 py-3 pl-4 pr-12 text-black max-w-full"
...
const useMessages = () => {
  ...
  const sendMessage = async (newMessage) => {
    ...
    const last10messages = newMessages.slice(-100) // remember last 10 messages
