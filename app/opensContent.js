...
const OpensData = [
    ...
    },
    {
        ...
        q4:"How many people should be in a team?",
        q5:"Who have prepared the problems?",
        q6:"Where can i find more information about IOI?",
        a0:"The registration dates for IOI may vary each year, depending on the host country and the event schedule,you can visit the official IOI website: https://ioinformatics.org/",
        a1:"The International Olympiad in Informatics (IOI) is an annual international competitive programming competition for secondary school students.",
        a2:"The IOI is hosted in a different country each year. The competition rotates among various participating countries.",
        a3:"The IOI is open to secondary school students from around the world. Each country selects its team through national or regional olympiads.",
        a4:"Participants compete as individuals rather than in teams",
        a5:"The problems for the IOI are designed by a team of experienced problem setters and coordinators",
        a6:"Here!: https://ioinformatics.org/ and here!: https://t.me/acmkz",
    },
  ];
